...
<!-- back to top button-->
<button id="myBtn" title="Lên đầu trang"><img src="/assetsClient/img/buttonTop.png" title='lên đầu trang' width='30px' height="30px" /></button>
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="login_box_img">
          <img class="img-fluid" src="/assetsClient/img/login.jpg" alt="">
          <div class="hover">
            <h4>Bạn là người mới?</h4>
            <p>Hãy tạo tài khoản để mua hàng ở trang web chúng tôi!</p>
            <a class="primary-btn" href="/registration">Tạo tài khoản</a>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="login_form_inner">
          ...
          <form class="row login_form" onclick="return checkForm()" method="post" id="contactForm">
            ...
            <div class="col-md-12 form-group">
              ...
              <span class="mt-3 float-left"><? (!empty($errol) ? $errol : false) ?></span>
...
<script>
  ...
  function checkForm() {
    ...
    if (nodeInput[1].value != "" && nodeInput[2].value != "") {
      ...
      document.getElementById("contactForm").setAttribute("action", "/login");
      return true;
    } else {
