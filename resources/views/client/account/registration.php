      ...
      <div class="col-lg-6">
        <div class="login_form_inner">
          ...
          <form class="row login_form pb-3" method="post" enctype="multipart/form-data" id="registrationForm">
            ...
            ?>
            <div class="col-md-12 form-group">
              <button type="submit" value="submit" class="primary-btn" onclick="return checkForm2()">Đăng kí</button>
...
<script>
  ...
  function checkForm2() {
    ...
    if (nodeInput[1].value != '' && nodeInput[2].value != '' && nodeInput[3].value != '' && nodeInput[4].value != '' && nodeInput[5].value != '' && nodeInput[6].value != '' && nodeInput[7].value != '') {
      ...
      document.getElementById("registrationForm").setAttribute("action", "/registration");
      return true;
    } else {
...
<?php
include '../resources/views/footerRegister.php';
